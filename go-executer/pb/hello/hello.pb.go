...
const file_hello_proto_rawDesc = "" +
	...
	"\fHelloService\x125\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\x127\n" +
	"\n" +
	"SayGoodbye\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponseB\x15Z\x13echo-hello/pb;hellob\x06proto3"
...
var file_hello_proto_depIdxs = []int32{
	...
	0, // 1: hello.HelloService.SayGoodbye:input_type -> hello.HelloRequest
	1, // 2: hello.HelloService.SayHello:output_type -> hello.HelloResponse
	1, // 3: hello.HelloService.SayGoodbye:output_type -> hello.HelloResponse
