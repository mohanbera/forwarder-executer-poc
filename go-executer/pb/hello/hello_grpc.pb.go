...
const (
	...
	HelloService_SayGoodbye_FullMethodName = "/hello.HelloService/SayGoodbye"
)
...
func (c *helloServiceClient) SayGoodbye(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, HelloService_SayGoodbye_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloServiceServer) SayGoodbye(context.Context, *HelloRequest) (*HelloResponse, error) {
