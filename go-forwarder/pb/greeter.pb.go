...
const file_proto_greeter_proto_rawDesc = "" +
	"\n" +
	"\x13proto/greeter.proto\x12\x02pb\"\"\n" +
	...
	"\aGreeter\x121\n" +
	"\vStreamHello\x12\x10.pb.HelloRequest\x1a\x0e.pb.HelloReply0\x01B\x19Z\x17go-forwarder/greeter/pbb\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	0, // 0: pb.Greeter.StreamHello:input_type -> pb.HelloRequest
	1, // 1: pb.Greeter.StreamHello:output_type -> pb.HelloReply
